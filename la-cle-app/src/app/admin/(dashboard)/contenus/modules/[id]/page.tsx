              ...
              {activeTab === "videos" && (
                <div className="space-y-4">
                  <div className="flex justify-end">
                    <Button variant="primary" size="sm" icon={<Plus className="h-4 w-4" />}>Ajouter une video</Button>
                  </div>
                  {videos.length === 0 ? (
                ...
                <Card>
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between">
                      <Toggle enabled={module_.isPublished} onChange={() => {}} label="Module publie" />
                      <Button variant="danger" size="sm" icon={<Trash2 className="h-4 w-4" />}>Supprimer</Button>
                    </div>
                  </div>
                </Card>
              )}
